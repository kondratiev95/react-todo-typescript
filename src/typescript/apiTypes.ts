import { credentials, Todo, responseAuthDataType, tokensTypes } from "./types";
...
export type setRegistrationApi = (data: credentials) => Promise<boolean>
export type setLoginApiType = (data: credentials) => Promise<responseAuthDataType>
export type refreshApiType = (data: tokensTypes) => Promise<responseAuthDataType>
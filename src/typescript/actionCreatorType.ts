...
import { responseAuthDataType } from './types';

export type  setTodoRequestACType = () => { type: typeof actions.getTodoList.REQUEST}
...
export type deleteCompletedRequestACType = () => { type: typeof actions.deleteCompletedTodo.REQUEST};
...
export type credentialsSuccessACType = (payload: boolean) => { type: typeof actions.sendCredentials.SUCCESS, payload: boolean}
...
export type sendLoginSuccessACType = (payload: responseAuthDataType) => { type: typeof actions.sendLoginValue.SUCCESS, payload: responseAuthDataType};
...
export type setRefreshSuccessType = (payload: responseAuthDataType) => ({
    type: typeof actions.refreshActions.SUCCESS,
    payload: responseAuthDataType
});
